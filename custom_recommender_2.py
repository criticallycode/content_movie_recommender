...
from sklearn.metrics.pairwise import linear_kernel, cosine_similarity, euclidean_distances, sigmoid_kernel, rbf_kernel
...
# now we can make a function to handle the actual recommendations
